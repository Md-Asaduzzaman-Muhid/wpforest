	...
	class IVE_Block_Helper {
		...
		public static function get_multiblock_slider_css( $attr, $id ) {
			...
			$selectors = array(
				' .ive-carousel-content-wrap' => array(
					'padding'				=> ( !empty($innerPadding) ) ? ($innerPadding[2].$unit.' '.$innerPadding[1].$unit.' '.$innerPadding[3].$unit.' '.$innerPadding[0].$unit).' !important' : 0,
					'border-width'			=> ( !empty($contentBorder) ) ? ($contentBorder[2].$unit.' '.$contentBorder[1].$unit.' '.$contentBorder[3].$unit.' '.$contentBorder[0].$unit).' !important' : 0,
			...
			$m_selectors = array(
				...
				' .owl-nav button.owl-prev' => array(
					'padding'				=> (!empty($arrowBtnPadding) ? ($arrowBtnPadding[2][0].$unit.' '.$arrowBtnPadding[2][1].$unit.' '.$arrowBtnPadding[2][2].$unit.' '.$arrowBtnPadding[2][3].$unit).' !important' : ''),
					'left'					=> ( !empty($owlNavLeft) ) ? $owlNavLeft[2].'% !important' : 0,
				),
				' .owl-nav button.owl-next' => array(
					'padding'				=> (!empty($arrowBtnPadding) ? ($arrowBtnPadding[2][0].$unit.' '.$arrowBtnPadding[2][1].$unit.' '.$arrowBtnPadding[2][2].$unit.' '.$arrowBtnPadding[2][3].$unit).' !important' : ''),
					'right'					=> ( !empty($owlNavRight) ) ? $owlNavRight[2].'% !important' : 0,
				),
				' .owl-nav button i' => array(
					'font-size'				=> (!empty($navArrowSize) ? $navArrowSize[2].$unit : '20'.$unit ).' !important'
				),
				' .owl-dots .owl-dot span' => array(
				  'border-width'			=> ( !empty($navArrowBdWidth) ) ? $navArrowBdWidth[2].$unit.' !important' : 0,
				),
			...
			$t_selectors = array(
				' .owl-nav' => array(
					'max-width'				=> ( !empty($owlNavMaxWidth) ) ? $owlNavMaxWidth[1].'% !important' : '100% !important',
					'top'					=> ( !empty($owlNavTop) ) ? $owlNavTop[1].'% !important' : '35% !important',
				),
				' .owl-nav button' => array(
					'width'					=> ( !empty($arrowBtnWidth) ) ? $arrowBtnWidth[1].$unit.' !important' : '40'.$unit.' !important',
					'height'				=> ( !empty($arrowBtnHeight) ) ? $arrowBtnHeight[1].$unit.' !important' : '40'.$unit.' !important',
					'border-width'			=> ( !empty($navArrowBdWidth) ) ? $navArrowBdWidth[1].$unit.' !important' : 0,
					'position'				=> 'relative !important'
				),
				' .owl-nav button.owl-prev' => array(
					'padding'				=> (!empty($arrowBtnPadding) ? ($arrowBtnPadding[1][0].$unit.' '.$arrowBtnPadding[1][1].$unit.' '.$arrowBtnPadding[1][2].$unit.' '.$arrowBtnPadding[1][3].$unit).' !important' : ''),
					'left'					=> ( !empty($owlNavLeft) ) ? $owlNavLeft[1].'% !important' : 0,
				),
				' .owl-nav button.owl-next' => array(
					'padding'				=> (!empty($arrowBtnPadding) ? ($arrowBtnPadding[1][0].$unit.' '.$arrowBtnPadding[1][1].$unit.' '.$arrowBtnPadding[1][2].$unit.' '.$arrowBtnPadding[1][3].$unit).' !important' : ''),
					'right'					=> ( !empty($owlNavRight) ) ? $owlNavRight[1].'% !important' : 0,
				),
				' .owl-nav button i' => array(
					'font-size'				=> (!empty($navArrowSize) ? $navArrowSize[1].$unit : '20'.$unit ).' !important'
				),
				' .owl-dots .owl-dot span' => array(
				  'border-width'			=> ( !empty($navArrowBdWidth) ) ? $navArrowBdWidth[1].$unit.' !important' : 0,
				),
			...
			$d_selectors = array(
				' .owl-nav' => array(
					'max-width'				=> ( !empty($owlNavMaxWidth) ) ? $owlNavMaxWidth[0].'% !important' : '100% !important',
					'top'					=> ( !empty($owlNavTop) ) ? $owlNavTop[0].'% !important' : '35% !important',
				),
				' .owl-nav button' => array(
					'width'					=> ( !empty($arrowBtnWidth) ) ? $arrowBtnWidth[0].$unit.' !important' : '40'.$unit.' !important',
					'height'				=> ( !empty($arrowBtnHeight) ) ? $arrowBtnHeight[0].$unit.' !important' : '40'.$unit.' !important',
					'border-width'			=> ( !empty($navArrowBdWidth) ) ? $navArrowBdWidth[0].$unit.' !important' : 0,
					'position'				=> 'relative !important'
				),
				' .owl-nav button.owl-prev' => array(
					'padding'				=> (!empty($arrowBtnPadding) ? ($arrowBtnPadding[0][0].$unit.' '.$arrowBtnPadding[0][1].$unit.' '.$arrowBtnPadding[0][2].$unit.' '.$arrowBtnPadding[0][3].$unit).' !important' : ''),
					'left'					=> ( !empty($owlNavLeft) ) ? $owlNavLeft[0].'% !important' : 0,
				),
				' .owl-nav button.owl-next' => array(
					'padding'				=> (!empty($arrowBtnPadding) ? ($arrowBtnPadding[0][0].$unit.' '.$arrowBtnPadding[0][1].$unit.' '.$arrowBtnPadding[0][2].$unit.' '.$arrowBtnPadding[0][3].$unit).' !important' : ''),
					'right'					=> ( !empty($owlNavRight) ) ? $owlNavRight[0].'% !important' : 0,
				),
				' .owl-nav button i' => array(
					'font-size'				=> (!empty($navArrowSize) ? $navArrowSize[0].$unit : '20'.$unit ).' !important'
				),
				' .owl-dots .owl-dot span' => array(
				  'border-width'			=> ( !empty($navArrowBdWidth) ) ? $navArrowBdWidth[0].$unit.' !important' : 0,
				),
		...
		public static function get_tabs_css($attr, $id){
		  ...
		  $borderRadius		= isset($attr['titleBorderRadius']) ? $attr['titleBorderRadius'].'px !important' : '';
			// $padding		= isset($attr['titlePadding']) ? $attr['titlePadding'].'px !important' : '';
		  ...
		  $widthType		= isset($attr['widthType']) ? $attr['widthType'] : '';
		  $layout		= isset($attr['layout']) ? $attr['layout'] : '';
	    ...
	    $selectors[$tabHeadingClass]['padding'] = $titlePaddingTop. $titlePaddingRight.$titlePaddingBottom.$titlePaddingLeft .' !important' ;
	    $selectors[$tabHeadingClass]['border-color'] = $borderColor	;
		  ...
		  if( $layout==='tabs' && $widthType=== 'percent' ){
		     $marginRight = isset($attr['gutter'][ 0 ]) ? $attr['gutter'][ 0 ].'px' : '';
		     $marginTab = ' 0px ';
		...
		public static function get_accordion_css($attr, $id){
		  ...
		  $d_selectors[' .ive-accordions-xl-end']['justify-content']	= 'right !important';
			...
			$accordians8Class = '.ive-start-active-pane-'.$openPane1.':not( .ive-accodion-icon-style-basic ):not( .ive-accodion-icon-style-xclose ):not( .ive-accodion-icon-style-arrow ) .ive-accordion-pane-'.$openPane1.' .ive-blocks-accordion-icon-trigger:before, .ive-accordion-'. $attr['uniqueID'].'.ive-start-active-pane-'.$openPane1.':not( .ive-accodion-icon-style-basic ):not( .ive-accodion-icon-style-xclose ):not( .ive-accodion-icon-style-arrow ) .ive-accordion-pane-'.$openPane1.'.ive-blocks-accordion-icon-trigger:after';
			...
			$selectors[$accordianHeaderClass]['color']= $color;
			...
			if(!$attr['iconGrad']){
				$selectors[$accordianHeaderClass]['background']= $background;
				$selectors[$accordianHeaderClass.':hover']['background-color']= $backgroundHover;
				...
				$selectors[$accordians8Class]['background-color']= $backgroundActive ;
			}
			if($attr['iconGrad']){
				if($gradType === 'radial'){
					$gradient = ' radial-gradient(at '.$gradRadPos.', '. $gradFirstColor.' '. $gradFirstLoc .' , '. $gradSecondColor .' '. $gradSecondLoc .' ) !important' ;
				...
				$selectors[$accordianHeaderHoverClass.':hover']['background-image']= $gradientHover;
				...
				$selectors[$accordians8Class]['background-image']= $gradientActive;
			}
		  ...
		  $accordiansClass = ':not( .ive-accodion-icon-style-basiccircle ):not( .ive-accodion-icon-style-xclosecircle ):not( .ive-accodion-icon-style-arrowcircle ) .ive-blocks-accordion-header .ive-blocks-accordion-icon-trigger:before, .ive-accordion-'.$attr['uniqueID'].':not( .ive-accodion-icon-style-basiccircle ):not( .ive-accodion-icon-style-xclosecircle ):not( .ive-accodion-icon-style-arrowcircle ) .ive-blocks-accordion-header .ive-blocks-accordion-icon-trigger:after';
			$selectors[$accordiansClass]['background-color']= $color;

		  $accordians2Class = ':not( .ive-accodion-icon-style-basic ):not( .ive-accodion-icon-style-xclose ):not( .ive-accodion-icon-style-arrow ) .ive-blocks-accordion-header .ive-blocks-accordion-icon-trigger:before, .ive-accordion-'.$attr['uniqueID'].':not( .ive-accodion-icon-style-basic ):not( .ive-accodion-icon-style-xclose ):not( .ive-accodion-icon-style-arrow ) .ive-blocks-accordion-header .ive-blocks-accordion-icon-trigger:after';
			$selectors[$accordians2Class]['background-color']= $background;

		  $accordians3Class = ':not( .ive-accodion-icon-style-basic ):not( .ive-accodion-icon-style-xclose ):not( .ive-accodion-icon-style-arrow ) .ive-blocks-accordion-header .ive-blocks-accordion-icon-trigger';
			$selectors[$accordians3Class]['background-color']= $color;

		  $accordians4Class = ':not( .ive-accodion-icon-style-basiccircle ):not( .ive-accodion-icon-style-xclosecircle ):not( .ive-accodion-icon-style-arrowcircle ) .ive-blocks-accordion-header:hover .ive-blocks-accordion-icon-trigger:before, .ive-accordion-${ uniqueID }:not( .ive-accodion-icon-style-basiccircle ):not( .ive-accodion-icon-style-xclosecircle ):not( .ive-accodion-icon-style-arrowcircle ) .ive-blocks-accordion-header:hover .ive-blocks-accordion-icon-trigger:after';
			$selectors[$accordians4Class]['background-color']= $colorHover;

			$accordians5Class = ':not( .ive-accodion-icon-style-basic ):not( .ive-accodion-icon-style-xclose ):not( .ive-accodion-icon-style-arrow ) .ive-blocks-accordion-header:hover .ive-blocks-accordion-icon-trigger:before, .ive-accordion-${ uniqueID }:not( .ive-accodion-icon-style-basic ):not( .ive-accodion-icon-style-xclose ):not( .ive-accodion-icon-style-arrow ) .ive-blocks-accordion-header:hover .ive-blocks-accordion-icon-trigger:after';
			$selectors[$accordians5Class]['background-color']= $backgroundHover;

			$accordians6Class = ':not( .ive-accodion-icon-style-basic ):not( .ive-accodion-icon-style-xclose ):not( .ive-accodion-icon-style-arrow ) .ive-blocks-accordion-header:hover .ive-blocks-accordion-icon-trigger';
			$selectors[$accordians6Class]['background-color']= $backgroundHover;


			$accordians7Class = '.ive-start-active-pane-'.$openPane1.':not( .ive-accodion-icon-style-basiccircle ):not( .ive-accodion-icon-style-xclosecircle ):not( .ive-accodion-icon-style-arrowcircle ) .ive-accordion-pane-'.$openPane1.' .ive-blocks-accordion-icon-trigger:before, .ive-accordion-'. $attr['uniqueID'].'.ive-start-active-pane-'.$openPane1.':not( .ive-accodion-icon-style-basiccircle ):not( .ive-accodion-icon-style-xclosecircle ):not( .ive-accodion-icon-style-arrowcircle ) .ive-accordion-pane-'.$openPane1.' .ive-blocks-accordion-icon-trigger:after';
			$selectors[$accordians7Class]['background-color']= $colorActive;

			$accordians9Class = '.ive-start-active-pane-'.$openPane1.':not( .ive-accodion-icon-style-basic ):not( .ive-accodion-icon-style-xclose ):not( .ive-accodion-icon-style-arrow ) .ive-accordion-pane-'.$openPane1.' .ive-blocks-accordion-icon-trigger';
			$selectors[$accordians9Class]['background-color']= $colorActive;
